 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --bpp 1 --size 12 --font /Users/vaja/SquareLine/assets/digital-7.ttf -o /Users/vaja/SquareLine/assets/ui_font_digi_small.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "ui.h"

#ifndef UI_FONT_DIGI_SMALL
#define UI_FONT_DIGI_SMALL 1
#endif

#if UI_FONT_DIGI_SMALL
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_digi_small = {
#else
lv_font_t ui_font_digi_small = {
#endif
